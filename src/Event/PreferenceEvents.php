...
final class PreferenceEvents
{
	 ...
	 *
	 * @Event("App\PersistentPreferenceBundle\Event\PreferenceEvent")
	 */
	public const PRE_SET = 'persistent_preference.pre_set';
	 ...
	 * @Event("App\PersistentPreferenceBundle\Event\PreferenceEvent")
	 */
	public const POST_SET = 'persistent_preference.post_set';
}